/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: a83c80f751eb6a24c0cae9908a233755)
// Runtime types generated with workerd@1.20260329.1 2026-04-03 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PLAYBOX_KV: KVNamespace;
		PLAYBOX_R2: R2Bucket;
		PLAYBOX_D1: D1Database;
		PLAYBOX_EVENTS: AnalyticsEngineDataset;
		ASSETS: Fetcher;
		GH_PROXY_JSD_ENABLE: "0";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GH_PROXY_JSD_ENABLE">> {}
}
